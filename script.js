const desafios = [
    { prod: "YoPRO Chocolate", frente: "assets/yopro-frente.png", rotulo: "assets/yopro-rotulo.png", titulo: "YoPRO: Adoçantes", missao: "Qual edulcorante substitui o açúcar neste produto?", alvos: ["Sacarose"], opcoes: ["Mel", "Sacarose", "Açúcar mascavo", "Glicose"], explica: "A Sucralose é um edulcorante que confere doçura sem as calorias do açúcar comum." },
